...
export const metadata: Metadata = {
  ...
  description: "Dịch vụ xe ghép Nam Định - Hà Nội uy tín, giá rẻ. Đưa đón tận nơi, xe mới, lái xe chuyên nghiệp. Ghép ghế 250k, Bao xe 4 chỗ 900k, Bao xe 7 chỗ 1100k. Liên hệ: 0971852897",
  openGraph: {
    title: "Xe Ghép Nam Định - Hà Nội | Dịch Vụ Đưa Đón Uy Tín, Giá Rẻ",
  ...
  const benefits = [
    {
      ...
      description: "Đưa đón tận nơi, linh hoạt theo lịch trình của bạn. Không cần đến bến xe, tiết kiệm thời gian di chuyển.",
      icon: (
    ...
    },
    {
      ...
      description: "Giá cả hợp lý, tiết kiệm hơn nhiều so với xe riêng hay taxi. Nhiều lựa chọn từ ghép ghế đến bao xe.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Xe mới, sạch sẽ, tài xế lái xe an toàn và thân thiện. Cam kết đúng giờ, đúng địa điểm.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Đáp ứng mọi nhu cầu: đi làm, thăm thân, du lịch, ra sân bay. Có cả ghép ghế và bao riêng xe.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Đặt xe nhanh chóng qua điện thoại hoặc Zalo. Chỉ cần một cuộc gọi là có xe đón bạn.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Thoải mái hơn xe khách, rẻ hơn taxi, nhanh hơn xe bus. Không lo tắc đường hay tìm chỗ đỗ xe.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl mb-8 text-gray-100 max-w-2xl mx-auto">
            Liên hệ với chúng tôi để đặt xe và nhận được tư vấn chi tiết về dịch vụ
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:0971852897"
