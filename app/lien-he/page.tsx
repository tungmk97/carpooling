...
export const metadata: Metadata = {
  title: "Liên Hệ | Xe Ghép Nam Định - Hà Nội - Nội Bài",
  description:
    "Liên hệ đặt Xe Ghép Nam Định - Hà Nội - Nội Bài. Gọi điện: 0971852897 hoặc nhắn tin Zalo. Hướng dẫn đặt xe nhanh chóng, đơn giản.",
  openGraph: {
    title: "Liên Hệ | Xe Ghép Nam Định - Hà Nội - Nội Bài",
    description:
      "Liên hệ đặt Xe Ghép Nam Định - Hà Nội - Nội Bài. Gọi điện: 0971852897 hoặc nhắn tin Zalo",
    type: "website",
    locale: "vi_VN",
  },
};
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3">
                    Gọi điện thoại hoặc nhắn tin Zalo theo số{" "}
                    <strong className="text-primary">0971 852 897</strong>
                  </p>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-primary">
                    <p className="text-sm text-gray-600">
                      <strong>Lưu ý:</strong> Bạn cũng có thể liên hệ qua
                      Facebook hoặc các kênh khác nếu có
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3">
                    Cung cấp các thông tin sau để chúng tôi phục vụ bạn tốt
                    nhất:
                  </p>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Điểm đón:</strong> Địa chỉ cụ thể nơi bạn muốn
                        được đón
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Điểm trả:</strong> Địa chỉ nơi bạn muốn được trả
                        khách
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Thời gian:</strong> Ngày giờ bạn muốn đi (hoặc
                        thời gian linh hoạt)
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Số lượng khách:</strong> Số người đi cùng (nếu
                        bao xe)
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Loại dịch vụ:</strong> Ghép ghế, bao xe 4 chỗ,
                        hay bao xe 7 chỗ
                      </span>
                    </li>
                  </ul>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3">
                    Sau khi xác nhận thông tin và giá cước, tài xế sẽ đến đón
                    bạn đúng giờ đã hẹn.
                  </p>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-primary">
                    <p className="text-sm text-gray-600">
                      <strong>Lưu ý:</strong> Vui lòng có mặt đúng giờ tại điểm
                      đón để đảm bảo lịch trình. Nếu có thay đổi, hãy liên hệ
                      với chúng tôi ngay.
                    </p>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600">
                  Phục vụ đón và trả khách tại mọi địa điểm trong thành phố Nam
                  Định và các huyện lân cận.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-primary mb-4">Hà Nội</h3>
                <p className="text-gray-600">
                  Phục vụ đón và trả khách tại tất cả các quận, huyện của Hà Nội
                  và sân bay Nội Bài.
                </p>
              </div>
            </div>
