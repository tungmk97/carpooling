      ...
      <section className="bg-gradient-to-r from-primary via-primary-dark to-primary text-white py-16 md:py-20 animated-gradient">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Dịch vụ Xe Ghép Nam Định - Hà Nội - Nội Bài uy tín, chất lượng cao
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p>
                ...
                là dịch vụ vận chuyển hành khách chuyên nghiệp, cung cấp giải
                pháp di chuyển tiện lợi, an toàn và tiết kiệm giữa Nam Định và
                Hà Nội.
              </p>
              <p>
                Chúng tôi hiểu rằng việc di chuyển giữa hai thành phố là nhu cầu
                thường xuyên của nhiều người dân, từ công việc, học tập đến thăm
                thân hay du lịch. Vì vậy, chúng tôi cam kết mang đến dịch vụ
                chất lượng cao với giá cả hợp lý.
              </p>
              <p>
                Với đội ngũ tài xế giàu kinh nghiệm, xe mới, sạch sẽ và quy
                trình đặt xe đơn giản, chúng tôi tự hào là lựa chọn tin cậy của
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600">
                  Gọi điện hoặc nhắn tin Zalo cho chúng tôi để đặt xe. Cung cấp
                  thông tin về điểm đón, điểm trả và thời gian mong muốn.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Chúng tôi sẽ xác nhận lại thông tin đặt xe, loại dịch vụ (ghép
                  ghế hay bao xe), giá cả và thời gian đón.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Tài xế sẽ đến đón bạn đúng giờ tại địa điểm đã hẹn. An toàn di
                  chuyển và đưa bạn đến đích một cách thuận tiện nhất.
                </p>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Cam kết đón đúng giờ đã hẹn, giúp bạn chủ động trong lịch
                  trình của mình.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Tài xế lái xe an toàn, tuân thủ luật giao thông, xe được bảo
                  dưỡng định kỳ.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Tài xế thân thiện, nhiệt tình hỗ trợ khách hàng trong suốt
                  hành trình.
                </p>
              </div>
            </div>
